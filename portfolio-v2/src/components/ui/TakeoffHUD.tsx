    ...
    <div className="fixed inset-0 pointer-events-none z-30 select-none">
      ...
      >
        <div className="bg-slate-900/90 border border-emerald-500/30 rounded-lg p-4 w-48">
          ...
          <div className="text-center mb-4">
            <div className="text-slate-400 text-xs font-mono mb-1">GROUND SPEED</div>
            <div className={`text-4xl font-bold font-mono ${
              isReadyForLiftoff ? 'text-emerald-400' : 
              isAtRotation ? 'text-amber-400' : 'text-cyan-400'
            }`}>
              {speedKnots}
          ...
          <div className="relative h-6 bg-slate-700/50 rounded-full overflow-hidden mb-2">
            <motion.div
              className={`h-full rounded-full transition-colors ${
                isReadyForLiftoff ? 'bg-emerald-500' : 
                isAtRotation ? 'bg-amber-500' : 'bg-cyan-500'
              }`}
      ...
      >
        {groundSpeed < 5 && (
          <div className="bg-slate-900/90 border border-cyan-500/30 rounded-lg px-6 py-3 text-center">
            ...
            <div className="text-slate-400 text-sm">
              Hold <kbd className="bg-slate-700 px-2 py-0.5 rounded text-emerald-400 font-mono">W</kbd> or{' '}
              <kbd className="bg-slate-700 px-2 py-0.5 rounded text-cyan-400 font-mono">SHIFT</kbd> to accelerate
            </div>
          </div>
        )}
        ...
        {isAtRotation && !isReadyForLiftoff && (
          ...
          >
            ...
            <div className="text-slate-400 text-sm">
              Pull up with <kbd className="bg-slate-700 px-2 py-0.5 rounded text-emerald-400 font-mono">W</kbd>
            </div>
          </motion.div>
        )}
      ...
      >
        <div className="flex gap-4 rounded-lg bg-slate-900/80 border border-slate-700 px-4 py-2 text-xs text-slate-400">
          <span>
            <kbd className="rounded bg-slate-700 px-1.5 py-0.5 text-emerald-400 mr-1">W</kbd>
            Accelerate / Rotate
          </span>
          <span>
            <kbd className="rounded bg-slate-700 px-1.5 py-0.5 text-cyan-400 mr-1">SHIFT</kbd>
            Afterburner
          </span>
          <span>
            <kbd className="rounded bg-slate-700 px-1.5 py-0.5 text-amber-400 mr-1">Q</kbd>
            <kbd className="rounded bg-slate-700 px-1.5 py-0.5 text-amber-400">E</kbd>
            Steer
          </span>
          <span>
            <kbd className="rounded bg-slate-700 px-1.5 py-0.5 text-red-400">S</kbd>
            Brake
          </span>
        </div>
      </motion.div>
      ...
      >
        ...
        <svg width="120" height="80" viewBox="0 0 120 80" className="opacity-50">
          {/* Horizon line */}
          <line x1="0" y1="40" x2="40" y2="40" stroke="#10b981" strokeWidth="2" />
          <line x1="80" y1="40" x2="120" y2="40" stroke="#10b981" strokeWidth="2" />
          
          {/* Center markers */}
          <circle cx="60" cy="40" r="3" fill="none" stroke="#10b981" strokeWidth="2" />
          
          {/* Wing markers */}
          <line x1="35" y1="40" x2="50" y2="40" stroke="#10b981" strokeWidth="2" />
          <line x1="70" y1="40" x2="85" y2="40" stroke="#10b981" strokeWidth="2" />
          
          {/* Vertical reference */}
          <line x1="60" y1="45" x2="60" y2="60" stroke="#10b981" strokeWidth="2" />
        </svg>
      </motion.div>
    </div>
  );
