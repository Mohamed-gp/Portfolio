...
export const AIRCRAFT: Record<AircraftType, Aircraft> = {
  'b2-spirit': {
    id: 'b2-spirit',
    name: 'B-2 Spirit',
    description: 'Stealth Bomber - Silent but deadly. Perfect for sneaking past deadlines.',
    speed: 0.8,
    agility: 0.6,
    unlocked: true,
    color: '#1a1a2e',
  ...
  'f15-eagle': {
    id: 'f15-eagle',
    name: 'F-15 Eagle',
    description: 'Air Superiority Fighter - When you need to dominate the skies and your inbox.',
    speed: 1.0,
    agility: 0.9,
    unlocked: false,
    color: '#4a5568',
  ...
  'f35-lightning': {
    ...
    description: 'Stealth Multirole Fighter - The Swiss Army knife of the skies.',
    speed: 0.95,
    agility: 0.85,
    unlocked: false,
    color: '#2d3748',
