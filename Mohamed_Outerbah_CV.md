...
- **Quality signals:** 4.7/5 average across 73 in-app merchant survey responses; 99.8% uptime over the last 90 days with zero recorded incidents (public status page: [status.dzstore.org](https://status.dzstore.org)).
