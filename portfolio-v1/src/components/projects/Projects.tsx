...
export default function Projects() {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      description:
        "In its first 3 months live: 1,000+ active stores, 2,100+ products, 550+ orders, and 20+ merchants upgraded to paid PRO plans through SEO alone, adding ~120 new stores a week with new stores up 55% and orders up 190% month over month, 100% organic, zero ad spend, and 5.5M+ DZD in merchant sales (GMV), on 47,000+ visitors and 166,000+ pageviews. Co-founded this multi-tenant Shopify-equivalent SaaS and lead nearly all engineering: subdomain-per-store routing with Caddy on-demand TLS, a 44-model Prisma/PostgreSQL schema, a drag-and-drop storefront builder, per-region shipping plus a carrier layer covering 70 Algerian delivery companies behind 5 API adapters, abandoned-cart recovery, an affiliate system, and AI product descriptions; self-hosted on Hetzner via Docker with 99.95% uptime over the last 90 days. Cut running costs by moving the production Postgres off Neon to Supabase and persisting the image-optimizer cache across deploys, cutting the database bill by 50%+ (migrated with pg_dump at zero downtime) and retiring ~17 GB/month of CDN egress. Technical SEO drives acquisition: 15,000+ pages indexed with 600+ valid Google Shopping product snippets, now pulling 3,000+ Google Search clicks and 100,000+ impressions a month; search out-refers social 12:1 on the signup funnel even though social dominates raw storefront traffic. Merchants rate it 4.7/5 in the in-app survey.",
      features: [
