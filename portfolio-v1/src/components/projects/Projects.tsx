...
export default function Projects() {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      description: [
        "In its first months live: 1,100+ active stores, 2,500+ products, 650+ orders, and 25+ merchants upgraded to paid PRO plans through SEO alone, adding ~160 new stores a week with new stores up 55% and orders up 190% month over month, 100% organic, zero ad spend, and 5.5M+ DZD in merchant sales (GMV) on 47,000+ visitors and 166,000+ pageviews. Merchants rate it 4.7/5 in the in-app survey.",
